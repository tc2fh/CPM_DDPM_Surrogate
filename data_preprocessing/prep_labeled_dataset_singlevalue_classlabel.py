...
'''
load all data from the .zarr.zip files and save to an uncompressed zip file with a class label. This is required for edm2 training
...
This exploration did not work. Refer to prep_labeled_dataset_singlevalue_classlabel_singlechannel.py for the working code used to prepare
data for training described in the paper.
...
data_path = '' # path to the CC3D simulation output data, where each folder contains CC3D simulation replicates of a specific parameter set
